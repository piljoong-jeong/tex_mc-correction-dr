...
Therefore, we conclude that \textbf{geometry term} in $\mathit{P}(\bar{\mathrm{p}}_2)$ are mostly affect to final radiance: \PJ{Actually, spatial variance of final radiance?}
\begin{align}
